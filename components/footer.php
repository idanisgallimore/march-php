<div class="landing-section6 flex">
    ...
    <div class="landing-section6__social flex">
        ...
        <div class="ls6__icons flex">
            <a class="ls6__icon-link" href="https://instagram.com/" target="_blank"><i class="ls6_icon fab fa-instagram"></i></a>
            <a class="ls6__icon-link" href="https://twitter.com/" target="_blank"><i class="ls6_icon fab fa-twitter"></i></a>
            <a class="ls6__icon-link" href="https://snapchat.com/" target="_blank"><i class="ls6_icon fab fa-snapchat-ghost"></i></a>
            <a class="ls6__icon-link" href="https://facebook.com/" target="_blank"><i class="ls6_icon fab fa-facebook-f"></i></a>
        </div>
